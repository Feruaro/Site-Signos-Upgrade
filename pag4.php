        ...
        <section class="corpo-secao">
            ...
            <div class="corpo-secao-div">                              
                ...
                <h3 class="corpo-secao-div-sobre">
                    <ul>
						<li>Não dispensam um almoço em família.</li>
						<li>Amam reunir amigos para uma boa janta e um filme.</li>
						<li>Colecionam artefatos antigos e com significado emocional.</li>
						<li>Amantes dos animais.</li>
						<li>Gostam de praticar a caridade.</li>
						<li>São apaixonados pelo mar, cachoeira e piscina.</li>
						<li>Adoram ficar no conforto do seu lar.</li>
					</ul>
                </h3>
            </div>             

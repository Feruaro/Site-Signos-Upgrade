        ...
        <section class="corpo-secao">
            ...
            <div class="corpo-secao-div">                              
                ...
                <h3 class="corpo-secao-div-sobre">
                    <ul>
						<li>Viagens para países com uma cultura bem diferente da sua.</li>
						<li>Aventuras, trilhas, cachoeiras e acampamento.</li>
						<li>Estudos filosóficos e espirituais.</li>
						<li>Expandir os horizontes conhecendo gente nova.</li>
						<li>Liberdade de espírito e liberdade de expressão.</li>
						<li>Amam todos os animais!</li>												
					</ul>
                </h3>
            </div>             

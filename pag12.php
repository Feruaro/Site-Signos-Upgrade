        ...
        <section class="corpo-secao">
            ...
            <div class="corpo-secao-div">                              
                ...
                <h3 class="corpo-secao-div-sobre">
                    <ul>
						<li>Apreciam a arte, teatro e a música.</li>
						<li>Amantes do mar.</li>
						<li>Gostam de ajudar o próximo.</li>
						<li>Não dispensam um romantismo.</li>
						<li>Adoram tudo o que é místico e espiritual.</li>										
					</ul>
                </h3>
            </div>              
